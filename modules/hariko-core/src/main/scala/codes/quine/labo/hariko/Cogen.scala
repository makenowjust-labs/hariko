...
/** Utilities for cogens.
  ...
  *
  * @groupname primitive
  *   Primitive Co-generators
  * @groupprio primitive
  *   200
  *
  * @groupname collection
  *   Collection Co-generators
  * @groupprio collection
  *   210
  *
  * @groupname function
  *   Function Co-generators
  * @groupprio function
  *   220
  */
object Cogen {
  ...
  /** A product identity cogen.
    ...
    *
    * The name is derived from Haskell's Divisible method. See
    * [[https://hackage.haskell.org/package/contravariant-1.5.2/docs/Data-Functor-Contravariant-Divisible.html]].
    *
    * @group util
    */
  ...
  /** A set cogen.
    *
    * NOTE: a function generated by a generator built by this cogen seems buggy on `toString` if it is not shrunk. But
    * don't be afraid, it works without any problems.
    *
    * @group collection
    */
